! function() {
    ...
    const a = e.arrayToEnum(["string", "nan", "number", "integer", "float", "boolean", "date", "bigint", "symbol", "function", "undefined", "null", "array", "object", "unknown", "promise", "void", "never", "map", "set"]),
        ...
        s = e.arrayToEnum(["invalid_type", "invalid_literal", "custom", "invalid_union", "invalid_union_discriminator", "invalid_enum_value", "unrecognized_keys", "invalid_arguments", "invalid_return_type", "invalid_date", "invalid_string", "too_small", "too_big", "invalid_intersection_types", "not_multiple_of", "not_finite"]);
    ...
    const i = (t, n) => {
        ...
        switch (t.code) {
            ...
            case s.not_finite:
                ...
                break;
            default:
                r = n.defaultError, e.assertNever(t)
        }
        return {
            message: r
        }
    ...
    function d(e, t) {
        const a = o,
            n = (e => {
                ...
                let o = "";
                const d = n.filter((e => !!e)).slice().reverse();
                ...
                data: e.data,
                path: e.path,
                errorMaps: [e.common.contextualErrorMap, e.schemaErrorMap, a, a === i ? void 0 : i].filter((e => !!e))
            });
    ...
    class u {
        ...
        static mergeObjectSync(e, t) {
            ...
            for (const n of t) {
                ...
                if ("aborted" === t.status) return c;
                if ("aborted" === s.status) return c;
                "dirty" === t.status && e.dirty(), "dirty" === s.status && e.dirty(), "__proto__" === t.value || void 0 === s.value && !n.alwaysSet || (a[t.value] = s.value)
            }
            return {
                status: e.value,
                value: a
    ...
    function b(e) {
        ...
        if (t && (a || n)) throw new Error('Can\'t use "invalid_type_error" or "required_error" in conjunction with custom error map.');
        if (t) return {
            errorMap: t,
            description: s
        };
        return {
            errorMap: (t, s) => {
                ...
                return "invalid_enum_value" === t.code ? {
                    ...
                    message: r ? ? n ? ? s.defaultError
                } : "invalid_type" !== t.code ? {
                    message: s.defaultError
                } : {
                    message: r ? ? a ? ? s.defaultError
                }
            },
            description: s
        }
    ...
    class k {
        ...
        _parseSync(e) {
            ...
            if (y(t)) throw new Error("Synchronous parse encountered promise.");
            return t
        }
        _parseAsync(e) {
            const t = this._parse(e);
        ...
        async safeParseAsync(e, t) {
            const a = {
                ...
                r = await (y(s) ? s : Promise.resolve(s));
            return g(a, r)
        }
        refine(e, t) {
        ...
        refinement(e, t) {
            return this._refinement(((a, n) => !!e(a) || (n.addIssue("function" == typeof t ? t(a, n) : t), !1)))
        }
        _refinement(e) {
            return new _e({
                schema: this,
    ...
    const x = /^c[^\s-]{8,}$/i,
        ...
        Z = /^[0-9a-fA-F]{8}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{12}$/i,
        C = /^[a-z0-9_-]{21}$/i,
        T = /^[A-Za-z0-9-_]+\.[A-Za-z0-9-_]+\.[A-Za-z0-9-_]*$/,
        A = /^[-+]?P(?!$)(?:(?:[-+]?\d+Y)|(?:[-+]?\d+[.,]\d+Y$))?(?:(?:[-+]?\d+M)|(?:[-+]?\d+[.,]\d+M$))?(?:(?:[-+]?\d+W)|(?:[-+]?\d+[.,]\d+W$))?(?:(?:[-+]?\d+D)|(?:[-+]?\d+[.,]\d+D$))?(?:T(?=[\d+-])(?:(?:[-+]?\d+H)|(?:[-+]?\d+[.,]\d+H$))?(?:(?:[-+]?\d+M)|(?:[-+]?\d+[.,]\d+M$))?(?:[-+]?\d+(?:[.,]\d+)?S)?)??$/,
        S = /^(?!\.)(?!.*\.\.)([A-Z0-9_'+\-\.]*)[A-Z0-9_+-]@([A-Z0-9][A-Z0-9\-]*\.)+[A-Z]{2,}$/i;
    let N;
    const j = /^(?:(?:25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])\.){3}(?:25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])$/,
    ...
    function D(e, t) {
        ...
        try {
            const [a] = e.split(".");
            if (!a) return !1;
            const n = a.replace(/-/g, "+").replace(/_/g, "/").padEnd(a.length + (4 - a.length % 4) % 4, "="),
                s = JSON.parse(atob(n));
            return "object" == typeof s && null !== s && ((!("typ" in s) || "JWT" === s ? .typ) && (!!s.alg && (!t || s.alg === t)))
        } catch {
            return !1
        }
    }
    ...
    function V(e, t) {
        return !("v4" !== t && t || !$.test(e)) || !("v6" !== t && t || !E.test(e))
    }
    class U extends k {
        _parse(t) {
            ...
            for (const a of this._def.checks)
                if ("min" === a.kind) t.data.length < a.value && (r = this._getOrReturnCtx(t, r), d(r, {
                    code: s.too_small,
                    minimum: a.value,
                    type: "string",
                    inclusive: !0,
                ...
                else if ("max" === a.kind) t.data.length > a.value && (r = this._getOrReturnCtx(t, r), d(r, {
                code: s.too_big,
                maximum: a.value,
                type: "string",
                inclusive: !0,
                ...
                (e || i) && (r = this._getOrReturnCtx(t, r), e ? d(r, {
                    code: s.too_big,
                    maximum: a.value,
                    type: "string",
                    inclusive: !0,
            ...
            } else if ("email" === a.kind) S.test(t.data) || (r = this._getOrReturnCtx(t, r), d(r, {
                validation: "email",
                code: s.invalid_string,
                message: a.message
            }), n.dirty());
            else if ("emoji" === a.kind) N || (N = new RegExp("^(\\p{Extended_Pictographic}|\\p{Emoji_Component})+$", "u")), N.test(t.data) || (r = this._getOrReturnCtx(t, r), d(r, {
                validation: "emoji",
                code: s.invalid_string,
                message: a.message
            }), n.dirty());
            else if ("uuid" === a.kind) Z.test(t.data) || (r = this._getOrReturnCtx(t, r), d(r, {
                validation: "uuid",
                code: s.invalid_string,
                message: a.message
            }), n.dirty());
            else if ("nanoid" === a.kind) C.test(t.data) || (r = this._getOrReturnCtx(t, r), d(r, {
                validation: "nanoid",
                code: s.invalid_string,
                message: a.message
            }), n.dirty());
            else if ("cuid" === a.kind) x.test(t.data) || (r = this._getOrReturnCtx(t, r), d(r, {
                validation: "cuid",
                code: s.invalid_string,
                message: a.message
            }), n.dirty());
            else if ("cuid2" === a.kind) w.test(t.data) || (r = this._getOrReturnCtx(t, r), d(r, {
                validation: "cuid2",
                code: s.invalid_string,
                message: a.message
            }), n.dirty());
            else if ("ulid" === a.kind) O.test(t.data) || (r = this._getOrReturnCtx(t, r), d(r, {
                validation: "ulid",
                code: s.invalid_string,
                message: a.message
            }), n.dirty());
                ...
                r = this._getOrReturnCtx(t, r), d(r, {
                    validation: "url",
                    code: s.invalid_string,
                    message: a.message
                }), n.dirty()
                ...
                a.regex.lastIndex = 0;
                a.regex.test(t.data) || (r = this._getOrReturnCtx(t, r), d(r, {
                    validation: "regex",
                    code: s.invalid_string,
                    message: a.message
                }), n.dirty())
            } else if ("trim" === a.kind) t.data = t.data.trim();
            else if ("includes" === a.kind) t.data.includes(a.value, a.position) || (r = this._getOrReturnCtx(t, r), d(r, {
                code: s.invalid_string,
                validation: {
                    includes: a.value,
                    position: a.position
            ...
            else if ("startsWith" === a.kind) t.data.startsWith(a.value) || (r = this._getOrReturnCtx(t, r), d(r, {
                code: s.invalid_string,
                validation: {
                    startsWith: a.value
                },
            ...
            else if ("endsWith" === a.kind) t.data.endsWith(a.value) || (r = this._getOrReturnCtx(t, r), d(r, {
                code: s.invalid_string,
                validation: {
                    endsWith: a.value
                },
                ...
                z(a).test(t.data) || (r = this._getOrReturnCtx(t, r), d(r, {
                    code: s.invalid_string,
                    validation: "datetime",
                    message: a.message
                }), n.dirty())
            } else if ("date" === a.kind) {
                L.test(t.data) || (r = this._getOrReturnCtx(t, r), d(r, {
                    code: s.invalid_string,
                    validation: "date",
                    message: a.message
                }), n.dirty())
            } else if ("time" === a.kind) {
                new RegExp(`^${M(a)}$`).test(t.data) || (r = this._getOrReturnCtx(t, r), d(r, {
                    code: s.invalid_string,
                    validation: "time",
                    message: a.message
                }), n.dirty())
            } else "duration" === a.kind ? A.test(t.data) || (r = this._getOrReturnCtx(t, r), d(r, {
                validation: "duration",
                code: s.invalid_string,
                message: a.message
            }), n.dirty()) : "ip" === a.kind ? (i = t.data, ("v4" !== (o = a.version) && o || !j.test(i)) && ("v6" !== o && o || !R.test(i)) && (r = this._getOrReturnCtx(t, r), d(r, {
                validation: "ip",
                code: s.invalid_string,
                message: a.message
            }), n.dirty())) : "jwt" === a.kind ? D(t.data, a.alg) || (r = this._getOrReturnCtx(t, r), d(r, {
                validation: "jwt",
                code: s.invalid_string,
                message: a.message
            }), n.dirty()) : "cidr" === a.kind ? V(t.data, a.version) || (r = this._getOrReturnCtx(t, r), d(r, {
                validation: "cidr",
                code: s.invalid_string,
                message: a.message
            }), n.dirty()) : "base64" === a.kind ? I.test(t.data) || (r = this._getOrReturnCtx(t, r), d(r, {
                validation: "base64",
                code: s.invalid_string,
                message: a.message
            }), n.dirty()) : "base64url" === a.kind ? P.test(t.data) || (r = this._getOrReturnCtx(t, r), d(r, {
    ...
    function K(e, t) {
        const a = (e.toString().split(".")[1] || "").length,
            ...
            s = a > n ? a : n;
        return Number.parseInt(e.toFixed(s).replace(".", "")) % Number.parseInt(t.toFixed(s).replace(".", "")) / 10 ** s
    }
    U.create = e => new U({
        checks: [],
    ...
    class B extends k {
        ...
        _parse(t) {
            ...
            const r = new u;
            for (const a of this._def.checks)
                if ("int" === a.kind) e.isInteger(t.data) || (n = this._getOrReturnCtx(t, n), d(n, {
                    code: s.invalid_type,
                    expected: "integer",
                    received: "float",
                    message: a.message
                ...
                (a.inclusive ? t.data < a.value : t.data <= a.value) && (n = this._getOrReturnCtx(t, n), d(n, {
                    code: s.too_small,
                    minimum: a.value,
                    type: "number",
            ...
            } else "multipleOf" === a.kind ? 0 !== K(t.data, a.value) && (n = this._getOrReturnCtx(t, n), d(n, {
                code: s.not_multiple_of,
                multipleOf: a.value,
                message: a.message
            }), r.dirty()) : "finite" === a.kind ? Number.isFinite(t.data) || (n = this._getOrReturnCtx(t, n), d(n, {
                code: s.not_finite,
                message: a.message
    ...
    class W extends k {
        ...
        _parse(t) {
            ...
            } else "multipleOf" === a.kind ? t.data % a.value !== BigInt(0) && (n = this._getOrReturnCtx(t, n), d(n, {
                code: s.not_multiple_of,
                multipleOf: a.value,
                message: a.message
            }), r.dirty()) : e.assertNever(a);
    ...
    class H extends k {
        _parse(t) {
            ...
            if (Number.isNaN(t.data.getTime())) {
                return d(this._getOrReturnCtx(t), {
                    code: s.invalid_date
                }), c
            }
            const n = new u;
            let r;
            for (const a of this._def.checks) "min" === a.kind ? t.data.getTime() < a.value && (r = this._getOrReturnCtx(t, r), d(r, {
                code: s.too_small,
                message: a.message,
                inclusive: !0,
                exact: !1,
                minimum: a.value,
                type: "date"
            }), n.dirty()) : "max" === a.kind ? t.data.getTime() > a.value && (r = this._getOrReturnCtx(t, r), d(r, {
                code: s.too_big,
                message: a.message,
                inclusive: !0,
                exact: !1,
    ...
    class ae extends k {
        _parse(e) {
            ...
            if (t.parsedType !== a.array) return d(t, {
                code: s.invalid_type,
                expected: a.array,
                received: t.parsedType
            }), c;
            ...
            if (null !== r.minLength && t.data.length < r.minLength.value && (d(t, {
                    code: s.too_small,
                ...
                }), n.dirty()), null !== r.maxLength && t.data.length > r.maxLength.value && (d(t, {
                    code: s.too_big,
                ...
                }), n.dirty()), t.common.async) return Promise.all([...t.data].map(((e, a) => r.type._parseAsync(new v(t, e, t.path, a))))).then((e => u.mergeArray(n, e)));
            const i = [...t.data].map(((e, a) => r.type._parseSync(new v(t, e, t.path, a))));
    ...
    function ne(e) {
        if (e instanceof se) {
            ...
            return new se({ ...e._def,
                shape: () => t
            })
        }
        return e instanceof ae ? new ae({ ...e._def,
            type: ne(e.element)
        }) : e instanceof ve ? ve.create(ne(e.unwrap())) : e instanceof ge ? ge.create(ne(e.unwrap())) : e instanceof de ? de.create(e.items.map((e => ne(e)))) : e
    }
    ...
    class se extends k {
        ...
        _parse(e) {
            ...
            if (!(this._def.catchall instanceof ee && "strip" === this._def.unknownKeys))
                for (const e in n.data) i.includes(e) || o.push(e);
            const l = [];
            for (const e of i) {
                const t = r[e],
                    a = n.data[e];
                l.push({
                    ...
                    value: t._parse(new v(n, a, n.path, e)),
            ...
            if (this._def.catchall instanceof ee) {
                ...
                else if ("strict" === e) o.length > 0 && (d(n, {
                ...
                for (const t of o) {
                    ...
                    l.push({
                        ...
                        value: e._parse(new v(n, a, n.path, t)),
            ...
            return n.common.async ? Promise.resolve().then((async () => {
                ...
                return e
            })).then((e => u.mergeObjectSync(t, e))) : u.mergeObjectSync(t, l)
        }
        get shape() {
            return this._def.shape()
        }
        strict(e) {
            return _.errToObj, new se({ ...this._def,
                unknownKeys: "strict",
                ...void 0 !== e ? {
                    errorMap: (t, a) => {
        ...
        pick(t) {
            const a = {};
            for (const n of e.objectKeys(t)) t[n] && this.shape[n] && (a[n] = this.shape[n]);
            return new se({ ...this._def,
                shape: () => a
            })
        }
        omit(t) {
            const a = {};
            for (const n of e.objectKeys(this.shape)) t[n] || (a[n] = this.shape[n]);
            return new se({ ...this._def,
                shape: () => a
            })
        }
        ...
        required(t) {
            const a = {};
            for (const n of e.objectKeys(this.shape))
                if (t && !t[n]) a[n] = this.shape[n];
                else {
                    let e = this.shape[n];
                    for (; e instanceof ve;) e = e._def.innerType;
                    a[n] = e
                }
            return new se({ ...this._def,
                shape: () => a
        ...
        keyof() {
            return pe(e.objectKeys(this.shape))
        }
    }
    ...
    class re extends k {
        _parse(e) {
            ...
            if (t.common.async) return Promise.all(a.map((async e => {
                ...
                const a = e.map((e => new r(e.ctx.common.issues)));
                return d(t, {
    ...
    function ie(t, s) {
        ...
        if (r === a.object && i === a.object) {
            const a = e.objectKeys(s),
                n = e.objectKeys(t).filter((e => -1 !== a.indexOf(e))),
                r = { ...t,
                    ...s
                };
            for (const e of n) {
    ...
    class oe extends k {
        _parse(e) {
            const {
                ...
                if (p(e) || p(n)) return c;
                const r = ie(e.value, n.value);
                return r.valid ? ((m(e) || m(n)) && t.dirty(), {
                    status: t.value,
                    value: r.data
                }) : (d(a, {
    ...
    class de extends k {
        _parse(e) {
            ...
            if (n.parsedType !== a.array) return d(n, {
                code: s.invalid_type,
                expected: a.array,
            ...
            const r = [...n.data].map(((e, t) => {
                ...
                return a ? a._parse(new v(n, e, n.path, t)) : null
            })).filter((e => !!e));
    ...
    class ue extends k {
        ...
        _parse(e) {
            ...
            if (n.parsedType !== a.map) return d(n, {
                code: s.invalid_type,
                expected: a.map,
                received: n.parsedType
            }), c;
            ...
            if (n.common.async) {
                ...
                return Promise.resolve().then((async () => {
                    for (const a of o) {
                        const n = await a.key,
                            s = await a.value;
                        if ("aborted" === n.status || "aborted" === s.status) return c;
    ...
    class ce extends k {
        _parse(e) {
            ...
            if (n.parsedType !== a.set) return d(n, {
                code: s.invalid_type,
                expected: a.set,
                received: n.parsedType
            }), c;
            const r = this._def;
            null !== r.minSize && n.data.size < r.minSize.value && (d(n, {
                code: s.too_small,
            ...
            }), t.dirty()), null !== r.maxSize && n.data.size > r.maxSize.value && (d(n, {
                code: s.too_big,
            ...
            const u = [...n.data.values()].map(((e, t) => i._parse(new v(n, e, n.path, t))));
            return n.common.async ? Promise.all(u).then((e => o(e))) : o(u)
        }
        min(e, t) {
    ...
    class me extends k {
        ...
        extract(e, t = this._def) {
            return me.create(e, { ...this._def,
                ...t
            })
        }
        exclude(e, t = this._def) {
            return me.create(this.options.filter((t => !e.includes(t))), { ...this._def,
                ...t
            })
        }
    }
    ...
    class ye extends k {
        ...
        _parse(e) {
            ...
            if (t.parsedType !== a.promise && !1 === t.common.async) return d(t, {
                code: s.invalid_type,
                expected: a.promise,
                received: t.parsedType
            }), c;
    ...
    class _e extends k {
        ...
        _parse(t) {
            const {
                status: a,
                ctx: n
            } = this._processInputParams(t), s = this._def.effect || null, r = {
                addIssue: e => {
                    d(n, e), e.fatal ? a.abort() : a.dirty()
                },
                get path() {
                    return n.path
                }
            ...
            if (r.addIssue = r.addIssue.bind(r), "preprocess" === s.type) {
                const e = s.transform(n.data, r);
                if (n.common.async) return Promise.resolve(e).then((async e => {
                    if ("aborted" === a.value) return c;
                    const t = await this._def.schema._parseAsync({
                        data: e,
                        path: n.path,
                        parent: n
                    });
                    return "aborted" === t.status ? c : "dirty" === t.status || "dirty" === a.value ? l(t.value) : t
                })); {
                    if ("aborted" === a.value) return c;
            ...
            if ("refinement" === s.type) {
                ...
                if (!1 === n.common.async) {
                    ...
                    return "aborted" === t.status ? c : ("dirty" === t.status && a.dirty(), e(t.value), {
                        status: a.value,
                        value: t.value
                    })
                }
                return this._def.schema._parseAsync({
                    ...
                    path: n.path,
                    parent: n
                }).then((t => "aborted" === t.status ? c : ("dirty" === t.status && a.dirty(), e(t.value).then((() => ({
                    status: a.value,
                    value: t.value
                }))))))
            }
            if ("transform" === s.type) {
                ...
                return this._def.schema._parseAsync({
                    ...
                    path: n.path,
                    parent: n
                }).then((e => f(e) ? Promise.resolve(s.transform(e.value, r)).then((e => ({
                    status: a.value,
                    value: e
                }))) : c))
            }
    ...
    _e.create = (e, t, a) => new _e({
        schema: e,
        typeName: Ce.ZodEffects,
        effect: t,
        ...b(a)
    }), _e.createWithPreprocess = (e, t, a) => new _e({
        schema: t,
        effect: {
            type: "preprocess",
            transform: e
    ...
    class ve extends k {
        _parse(e) {
            return this._getType(e) === a.undefined ? h(void 0) : this._def.innerType._parse(e)
        }
        unwrap() {
    ...
    class ge extends k {
        _parse(e) {
            return this._getType(e) === a.null ? h(null) : this._def.innerType._parse(e)
        }
        unwrap() {
            return this._def.innerType
        }
        ...
        _parse(e) {
            ...
            if (a.common.async) {
                return (async () => {
                    ...
                    return "aborted" === e.status ? c : "dirty" === e.status ? (t.dirty(), l(e.value)) : this._def.out._parseAsync({
                        data: e.value,
                        path: a.path,
                        parent: a
                    })
                ...
                return "aborted" === e.status ? c : "dirty" === e.status ? (t.dirty(), {
                    status: "dirty",
                    value: e.value
    ...
    class Ze extends k {
        _parse(e) {
            const t = this._def.innerType._parse(e),
                a = e => (f(e) && (e.value = Object.freeze(e.value)), e);
            return y(t) ? t.then((e => a(e))) : a(t)
        }
        unwrap() {
            return this._def.innerType
        }
    ...
    const Pe = le.create,
        Fe = he.create,
        Le = me.create;
    ye.create, ve.create, ge.create;
    var Me = "__PNS_RUNTIME__",
        ze = Symbol.for("lazyModuleRegistry");
    ...
    function De() {
        ...
        try {
            ...
            return (null == a ? void 0 : a.searchParams.get("globalName")) || Me
        } catch (e) {
            return Me
        }
    }
    ...
    var Ke, Be, We, qe, He = ["log", "error", "warn"];
        ...
        try {
            for (var r, i = function() {
                    ...
                    t[a] = function() {
                        ...
                        var r;
                        e() && (r = console)[a].apply(r, Ue(n))
                    }
                }, o = He[Symbol.iterator](); !(a = (r = o.next()).done); a = !0) i()
        } catch (e) {
            n = !0, s = e
        } finally {
            try {
    ...
    Je((function() {
        ...
        return "online" !== process.env.BUILD_TYPE
    })), Je((function() {
        return !0
    })), (Be = Ke || (Ke = {}))[Be.runtime = 0] = "runtime", Be[Be.compilation = 1] = "compilation", (qe = We || (We = {}))[qe.OFF = 0] = "OFF", qe[qe.SCHEMA = 1] = "SCHEMA", qe[qe.RAW = 2] = "RAW";
    var Ye = je(),
        Ge = Ie([Te(), Te().array()]),
        Xe = Ie([Te(), Ae(), Se(), Ne()]),
        Qe = Ee({
            ...
            $text: Te().optional(),
            $prefix: Te().optional(),
            $sufin: Re(Te()).optional(),
            $sufnin: Re(Te()).optional(),
            $in: Re(Xe).optional(),
            $nin: Re(Xe).optional()
        }),
        et = Ie([Fe("context"), Fe("self")]),
        tt = Ie([Fe("url"), Fe("host"), Fe("path"), Fe("search"), Fe("body"), Fe("header"), Fe("method"), Fe("destination"), Fe("source")]);
    Ie([Fe("block"), Fe("remove"), Fe("empty"), Fe("replace"), Fe("report")]);
    var at, nt = Ee({
            type: Fe("self")
        }).and(Ie([Ee({
            handler: Fe("report"),
        ...
        st = Ee({
            type: Ie([Fe("url"), Fe("host"), Fe("path"), Fe("search"), Fe("body"), Fe("header"), Fe("method"), Fe("destination")]),
            field: Ie([Re(Ie([Te(), Ae()])), Te()]).optional()
        }).and(Ie([Ee({
            handler: Fe("replace"),
            pattern: Qe.optional(),
            value: $e()
        }), Ee({
            handler: Ie([Fe("remove"), Fe("empty")])
        })])),
        rt = Ee({
            type: Ie([et, tt]),
            field: Ie([Te(), Re(Ie([Te(), Ae()]))]).optional(),
            pattern: Qe
        }),
        it = Ee({
            $or: Re(Pe((function() {
    ...
    var ut = Ie([nt, st]),
        ...
        ht = Ee({
            ...
            pattern: Ee({
                ...
                $text: Te().optional(),
                $prefix: Te().optional(),
                $sufin: Re(Xe).optional(),
                $sufnin: Re(Xe).optional(),
                $in: Re(Xe).optional(),
                $nin: Re(Xe).optional(),
                $or: Re(Ee({})).optional(),
                $and: Re(Ee({})).optional(),
    ...
    var mt = Ee({
        ...
        _t = Ee({
            enabled: Se().optional(),
            sampleRate: Ae(),
            stackSampleRate: Ae().optional(),
            stackCollectCookies: Re(Te()),
            blockers: Re(Ee({
                domains: Re(Te()),
                cookies: Re(Te())
            })),
            intercept: Re(ct).optional()
        }),
        vt = Ee({
            enabled: Se().optional(),
            sampleRate: Ae(),
            stackCollectKeys: Re(Te()).optional(),
            valueRate: Ae()
        }),
        gt = Ee({
            enabled: Se().optional(),
            apis: Re(Ee({
                ...
                apiName: Te(),
                block: Se().optional(),
                blockWithCallbackIdx: Ae().optional(),
                blockWithCallbackParams: Ee({}).optional(),
                paramCondition: Ee({}),
                withStack: Se(),
                stackRate: Ae(),
                withRawArguments: Re(Se()),
                freqSampleRate: Ae().optional()
            }))
        });
    Le(["OFF", "SCHEMA", "RAW"]);
    var bt = Ee({
            enabled: Se().optional(),
            enableGeneralReport: Se(),
            generalRate: Ae(),
            methods: Ee({})
        }),
        kt = Ee({
    ...
    Ee({
        ruleName: Te(),
        priority: Ae().optional(),
        addReplaceHeader: Se().optional(),
        conditions: Re(mt).optional(),
        handlers: Re(ft).optional()
    });
    var xt = Ee({
            enabled: Se().optional(),
            sampleRate: Ae(),
    ...
    function Ct(e, t) {
        ...
        if (null === e) n = "null";
            ...
            case "number":
                n = e % 1 == 0 ? "integer" : "number";
                break;
            case "string":
                n = "string",
                    function(e, t) {
                        var a = ["{}", "[]"],
                            n = "".concat(t[0]).concat(t[t.length - 1]);
                        if (a.indexOf(n) < 0) return;
                        try {
                            var s = JSON.parse(t);
                            e.jsonStringFormat = Ct(s, null)
                        } catch (e) {
                            return
                        }
                    }(s, e);
            ...
            case "boolean":
                ...
                break;
            case "object":
                var r = null !== (a = null == t ? void 0 : t.filter((function(e) {
                    return e.length > 0
                }))) && void 0 !== a ? a : null;
                return Array.isArray(e) ? function(e, t) {
                    ...
                    a.items = e.map((function(e, a) {
                        return Ct(e, t ? Tt(t, String(a)) : null)
                    })), a.items.slice(1).reduce((function(e, t) {
                        return e && At(a.items[0], t)
                    }), !0) && (a.items = a.items[0]);
                    return a
                }(e, r) : function(e, t) {
                    var a = {
                    ...
                    for (var n in e) a.properties = Object.assign(a.properties || {}, Zt({}, n, Ct(e[n], t ? Tt(t, n) : null)));
                    return a
                }(e, r)
        }
        if ((null == t ? void 0 : t.some((function(e) {
                return 0 === e.length
            }))) && (s.raw = e), n) return Object.assign({
            type: n
        }, s);
        throw new Error("Parse json body error: ".concat(JSON.stringify(e)))
    }
    ...
    function At(e, t) {
        if (1 == (Number(Boolean(e)) ^ Number(Boolean(t)))) return !1;
        if (!e && !t) return !0;
        if (e.type !== t.type) return !1;
        if ("object" === e.type) {
            var a = e.properties || {},
                n = t.properties || {};
            if (Object.keys(a) !== Object.keys(n)) return !1;
            for (var s in a)
                if (!At(a[s], n[s])) return !1
        }
        if ("array" === e.type) {
            var r = e.items,
                i = t.items,
                o = Array.isArray(r),
                d = Array.isArray(i);
            return o && d && r.length === i.length ? r.reduce((function(e, t, a) {
                return e && At(t, i[a])
            }), !0) : !o && !d && At(r, i)
        }
        return !0
    }! function(e, t) {
        var a, n, s, r, i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : De(),
            o = globalThis[i];
        if (o) {
            var d;
            null !== (d = (a = o)[n = ze]) && void 0 !== d || (a[n] = {});
            var u, c = o[ze];
            null !== (u = (s = c)[r = e]) && void 0 !== u || (s[r] = t)
        }
    }("to-json-schema", Ct)
}();